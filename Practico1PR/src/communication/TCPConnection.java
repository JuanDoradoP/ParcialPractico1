...
public class TCPConnection {
	...
	public void sendBroacast(String line) {
	...
	public void managerSendDirectMessage(String remitente, String destinatario, String mensaje) {
		getConnectionById(destinatario); 
